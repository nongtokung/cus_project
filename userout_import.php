...
<body>
	<div data-role="page">
		<div data-role="header">
			<h1>CSV file upload | DB: cus_db  | Table: user_out </h1>
		</div>

		<div data-role="main" class="ui-content">
			<form name="form1" action="userout_import_file.php" method="post" enctype="multipart/form-data" onSubmit="return OnUploadCheck();" data-ajax="false">
